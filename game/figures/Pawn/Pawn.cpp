...
std::vector<sf::Vector2i> Pawn::get_possible_moves(Board& board)
{
    ...
    if (board.get_figure_type(sf::Vector2i(current_x-1, next_move_y)) != FigureType::EMPTY)
    {
        moves.push_back(sf::Vector2i(current_x-1, next_move_y));
    }
