...
class Pawn : public Figure
{
    ...
    public:
        ...
        Pawn(const std::string& LIGHT_PAWN_PATH,const std::string& DARK_PAWN_PATH, const float FIGURE_SIZE, 
         sf::Vector2f pixel_position, sf::Vector2i board_position, FigureType type, bool is_first_move = true)
        
        : Figure(LIGHT_PAWN_PATH,DARK_PAWN_PATH, FIGURE_SIZE, pixel_position, board_position, type), c_is_first_move(is_first_move)
        {
